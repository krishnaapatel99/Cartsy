...
function Landingimages() {
  ...
  return (
    <div
      ...
      */
      className="relative flex justify-center items-center h-[45vh] md:h-[65vh] w-[95%] md:w-[55vw] mx-auto md:mx-0 overflow-visible mt-28 md:mt-0 mb-16 md:mb-24 z-[50] md:mr-12"
    >
      {/* Left Image */}
